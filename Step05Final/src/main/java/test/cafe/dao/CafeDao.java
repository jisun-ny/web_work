...
public class CafeDao {
	...
	/*
	static 메소드는 생성자를 호출하지 않고 클래스명으로 바로 호ㅜㄹ을 하기 때문에
	메소드 호출 전에 무언가 준비 작업을 하고 싶다면 static 블럭 안에서 하면 된다.
	static블럭은 해당 클래스를 최초로 사용할 때 한번만 실행되기 떄문에
	...
	*/
	...
	//외부에서 객체 생성하지 못하도록
	private CafeDao() {} //이래야지 싱글톤?을 유지..? 뭐라는거징..흠
	
	//참조값을 리턴해주는 static method
	public static CafeDao getInstance() {
		//여기서 리턴해 주는 값은 null이 아니다.
//		if(dao == null) {
//			dao = new CafeDao();
//		} --> 이렇게 하지 않고 위에 static 블럭 활용
		return dao;
	}
